...
async function getAllRoomsWithChatMessages(req, res){
  try{
    ...
    // Result of rooms with their messages and amound of messages
    let rooms = [];
    ...
    // 3. Add messages to unique rooms and count those message. Create object
    let mapRooms = {};
    ...
    if(allMessagesWithRooms.length > 0){
      // Add mesage to the room and count messages
