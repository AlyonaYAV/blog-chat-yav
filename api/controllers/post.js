...
module.exports.updatePost = async (req, res) =>{
  if(req.body.imagePostToDelete){
    // Remove previous image by name 'imlagePostDelete'
...
module.exports.addViewToPostById = async (request, response) => {
  ...
  try {
    const postUpdated = await Post.findOneAndUpdate({ _id: id }, update, { new: true });
    if(postUpdated){
