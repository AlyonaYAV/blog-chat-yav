...
import BlockList from './../../components/admin/sidebar/BlockList';
import SearchSettings from './../../components/admin/sidebar/SearchSettings';
export default {
    ...
    blockUpdateData(dataUpdating){
      try{
        ...
        window.setTimeout(async ()=>{
          ...
          // Relese 'Submit' button in child component
