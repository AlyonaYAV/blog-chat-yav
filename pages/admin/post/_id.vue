    ...
    <div>
      ...
      <div v-else>
        ...
        >
            ...
            <image-loader
              :imageLink="imageUrl"
              :oneDeleteSingleImage="deleteSingleImage"
...
export default {
  async asyncData (context) {
    ...
    if(userData.role && !userData.sessionEnd){
      ...
      // If Post dosen't exist go back to the list of Posts
  ...
  data () {
    return {
      ...
      rules: {
        ptitle: [
          { required: true, message: 'Post title mustn\'t', trigger: 'blur' }
        ],
        ptext: [
          { required: true, message: 'Post mustn\'t', trigger: 'blur' }
        ]
      }
    }
  },
